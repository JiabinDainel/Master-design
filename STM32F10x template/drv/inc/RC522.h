...
#define SET_SPI_CS  SPI_CSCtrl(SPI_2,RC522,CS_HIGH)
#define CLR_SPI_CS  SPI_CSCtrl(SPI_2,RC522,CS_LOW)

#define SET_RC522RST  GPIO_SetBits(RC522_RST_PIN_INDEX,RC522_RST_PIN);
#define CLR_RC522RST  GPIO_ResetBits(RC522_RST_PIN_INDEX,RC522_RST_PIN);
